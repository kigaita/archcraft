...
FILE="$HOME/.config/polybar/cynthia/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/cynthia/forest/scripts/rofi/launcher.rasi
